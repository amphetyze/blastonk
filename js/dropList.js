...
const generateDropBlock = (skin) => {
    ...
    if (!!skin?.id) {
        ...
        <div class="drop__bg-block">
            <div class="drop__hr" style="background: ${rarityDropColor[skin?.rarity]
            };"></div>
            <img src="https://sap-sap.ru/img/skins-blast-bg.png" alt="" class="drop__bg" />
            <img src="https://sap-sap.ru/img/skins/${skin.id}.png" alt="${skin.title
            }" class="drop__image" />
...
const addInitialSkins = () => {
    ...
    for (let i = 0; i < Math.ceil(screenWidth / 168); i++) {
